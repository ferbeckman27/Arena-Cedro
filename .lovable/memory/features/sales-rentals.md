...
- **Datas dos 4 jogos**: ao criar pacote, o sistema insere **4 registros** em `reservas`, um por **semana** (mesmo dia da semana/horário, intervalos de 7 dias): data escolhida, +7, +14, +21 dias. Cada registro recebe `valor_total = totalGeral/4` e observação `Pacote 4 jogos - Jogo N/4 [PACOTE-{timestamp}]` para vincular as 4. Isso garante que os 4 horários ficam reservados/visíveis no calendário a cada semana.
